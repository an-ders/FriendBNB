//
//  FloatingPromptTextFieldMultiline.swift
//  FriendBNB
//
...
public struct FloatingPromptTextFieldMultiline<Prompt: View, FloatingPrompt: View, TextFieldStyle: ShapeStyle>: View {
...
private extension FloatingPromptTextFieldMultiline where TextFieldStyle == HierarchicalShapeStyle {
...
private extension FloatingPromptTextFieldMultiline where Prompt == FloatingPrompt {
	init(text: Binding<String>,
		 textFieldStyle: TextFieldStyle,
		 @ViewBuilder prompt: () -> Prompt) {
		self.init(text: text,
...
public extension FloatingPromptTextFieldMultiline where TextFieldStyle == HierarchicalShapeStyle, Prompt == FloatingPrompt {
	/// Creates a FloatingPromptTextFieldMultiline with a string binding and a view that will be used
	/// as the prompt.
	///
	/// - Parameters:
...
public extension FloatingPromptTextFieldMultiline where TextFieldStyle == HierarchicalShapeStyle, Prompt == Text, FloatingPrompt == Text {
	/// Creates a FloatingPromptTextFieldMultiline with a string binding and a Text view that will be
	/// used as the prompt.
	///
	/// - Parameters:
	///   - text: A binding to the text to display and edit.
...
public extension FloatingPromptTextFieldMultiline {
	...
	func floatingPrompt<FloatingPromptType: View>(_ floatingPrompt: () -> FloatingPromptType) -> FloatingPromptTextFieldMultiline<Prompt, FloatingPromptType, TextFieldStyle> {
		FloatingPromptTextFieldMultiline<Prompt, FloatingPromptType, TextFieldStyle>(
			text: text,
			textFieldStyle: textFieldStyle,
			prompt: { prompt },
			floatingPrompt: { floatingPrompt() }
	...
	func textFieldForegroundStyle<Style: ShapeStyle>(_ style: Style) -> FloatingPromptTextFieldMultiline<Prompt, FloatingPrompt, Style> {
		FloatingPromptTextFieldMultiline<Prompt, FloatingPrompt, Style>(
			text: text,
