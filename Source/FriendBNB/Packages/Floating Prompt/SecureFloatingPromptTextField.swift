...
public struct SecureFloatingPromptTextField<Prompt: View, FloatingPrompt: View, TextFieldStyle: ShapeStyle>: View {
...
private extension SecureFloatingPromptTextField where TextFieldStyle == HierarchicalShapeStyle {
...
private extension SecureFloatingPromptTextField where Prompt == FloatingPrompt {
    init(text: Binding<String>,
         textFieldStyle: TextFieldStyle,
         @ViewBuilder prompt: () -> Prompt) {
        self.init(text: text,
...
public extension SecureFloatingPromptTextField where TextFieldStyle == HierarchicalShapeStyle, Prompt == FloatingPrompt {
...
public extension SecureFloatingPromptTextField where TextFieldStyle == HierarchicalShapeStyle, Prompt == Text, FloatingPrompt == Text {
...
public extension SecureFloatingPromptTextField {
    ...
    func floatingPrompt<FloatingPromptType: View>(_ floatingPrompt: () -> FloatingPromptType) -> SecureFloatingPromptTextField<Prompt, FloatingPromptType, TextFieldStyle> {
        SecureFloatingPromptTextField<Prompt, FloatingPromptType, TextFieldStyle>(
            text: text,
            textFieldStyle: textFieldStyle,
            prompt: { prompt },
            floatingPrompt: { floatingPrompt() }
    ...
    func textFieldForegroundStyle<Style: ShapeStyle>(_ style: Style) -> SecureFloatingPromptTextField<Prompt, FloatingPrompt, Style> {
        SecureFloatingPromptTextField<Prompt, FloatingPrompt, Style>(
            text: text,
